...
class RegisterMitraRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'business_permit' => 'required|file', // Accept file uploads for business_permit
    ...
    public function messages()
    {
        return [
            ...
            'business_permit.required' => 'Business Permit cannot be empty',
            ...
            'latitude.numeric' => 'Latitude must be a float',
            'longitude.required' => 'Longitude cannot be empty',
            'longitude.numeric' => 'Longitude must be a float',
        ];
    }
